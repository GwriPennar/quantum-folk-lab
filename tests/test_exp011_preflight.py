...
from scripts.run_exp011_preflight import load_and_validate_rows, parameterised_circuit
...
def test_preflight_has_no_submission_or_credential_surface() -> None:
    source = Path("scripts/run_exp011_preflight.py").read_text(encoding="utf-8")
